...
path_to_xparr = data_path + 'xparr/mc10_mega_MP_dr_only/'
path_to_indel_list = data_path + 'xparr/mc10_mega_MP_dr_only/indel_list.txt'
out_path = '../../res/mc10_mega_MP_dr_only_stat/'
