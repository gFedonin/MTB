...
from src.core.constants import codon_table, codon_table_compl

drug = 'Isoniazid'
mut = 'Gene\tkatG\t315\tS\tT\tsnp'
forward_tag = '[&!color=#ff0033]'
backward_tag = '[&!color=#00ff00]'

out_path = './data/colored_trees/'
    ...
    while j < len(snp_pos_list):
        ...
        if cds.strand == 1:
            ...
            if protein_pos == mut_pos:
                ...
                if aa0 == ref and aa1 == alt:
                    return 1
                if aa0 == alt and aa1 == ref:
                    return -1
