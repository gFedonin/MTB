...
path_to_var = '../../data/snps/annotated_with_DR_with_indel_with_pheno_and_snp_no_win_qual_mqm_std3_mqm30_no_highcov_long_del_pg_NWds10/'
path_to_ids = '../../data/dr_covered_with_pheno_and_snp.txt'

out_path = '../../data/snps/annotated_with_DR_with_indel_with_pheno_and_snp_no_win_qual_mqm_std3_mqm30_no_highcov_long_del_pg_NWds10_extended/'
