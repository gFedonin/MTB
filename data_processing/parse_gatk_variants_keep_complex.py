...
# path_to_variants = data_path + 'snps/gatk_before_cortex/'
# path_to_variants = data_path + 'snps/combined_nocoll/'
# path_to_variants = data_path + 'coll18/snps/gatk/'
path_to_variants = data_path + 'walker18/snps/gatk/'
# path_to_vcf = path_to_variants + 'vcf_split_gatk_fa_no_opt/'
# path_to_vcf = path_to_variants + 'vcf_split_gatk/'
# path_to_vcf = path_to_variants + 'vcf_split_bwa_combined/'
path_to_vcf = path_to_variants + 'vcf_split_bwa/'
# out_path = path_to_variants + 'raw_variants_mq40_keep_complex/'
out_path = path_to_variants + 'raw_variants_mq40_keep_complex/'
